            ...
            >
              ...
              <div className="p-8">
                ...
                <button
                  ...
                  className='w-full py-4 px-6 rounded-xl font-bold text-lg transition-all duration-300 bg-green-600 hover:bg-green-700 text-white shadow-lg hover:shadow-xl transform hover:scale-105'
                >
